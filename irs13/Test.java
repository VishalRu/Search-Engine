...
/*public class Test {
	...
	public static void main(String[] args) {
		...
		if(c==0)
			System.out.println("C equals zero!!!");
		else 
			System.out.println("C not equals zero!!!");
...
public static void updateKmatrix(int temp,int val, int n)
{
	for(int i=0; i<n;i++)
	{
		if(k[temp][i]==-1)
